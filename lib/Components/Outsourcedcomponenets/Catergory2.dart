...
class _ToggleTextBtnsFb1State extends State<ToggleTextBtnsFb1> {
  ...
  @override
  void initState() {
    // widget.texts.forEach((e) => isSelected.add(true));

    // isSelected.add(true);
    // for (var s = 1; s < widget.texts.length; s++) {
    //   isSelected.add(false);
    // }

var x = [false, false, false];
x[globalInt.value] = true;
isSelected = isSelected + x;    // widget.texts.forEach((e) => isSelected.add(false));
    super.initState();
  }
